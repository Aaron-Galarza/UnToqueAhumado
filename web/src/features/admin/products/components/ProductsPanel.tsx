  ...
  return (
    <div className="bg-white rounded-xl p-4 md:p-6 border border-gray-200 shadow-sm">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
              ...
              <input 
                ...
                className="w-full bg-gray-50 border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-900 focus:outline-none focus:border-[#FF5500]" 
              />
            </div>
            ...
            <div className="sm:col-span-2">
              ...
              <textarea 
                ...
                className="w-full bg-gray-50 border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-900 focus:outline-none focus:border-[#FF5500] resize-none"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  type="text" value={newProduct.image} onChange={(e) => setNewProduct({...newProduct, image: e.target.value})}
                  placeholder="https://..." 
                  className="w-full bg-gray-50 border border-gray-300 rounded-lg pl-9 pr-3 py-2 text-sm text-gray-900 focus:outline-none focus:border-[#FF5500]" 
                />
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col h-[400px] md:h-[420px] mt-2 lg:mt-0 pt-6 lg:pt-0 border-t lg:border-t-0 border-gray-200">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 gap-3">
            ...
            <select 
              ...
              className="bg-gray-50 border border-gray-300 text-gray-900 text-xs md:text-sm rounded-lg px-3 py-1.5 outline-none focus:border-[#FF5500] cursor-pointer"
            >
              ...
              <div key={product.id} className={`bg-gray-50 border rounded-xl p-3 flex items-center gap-3 md:gap-4 group transition-colors ${editingId === product.id ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'}`}>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] md:text-xs text-gray-500 truncate mb-1">
                    <span className="text-[#FF5500]">{product.category}</span> • {product.description}
                  </p>
