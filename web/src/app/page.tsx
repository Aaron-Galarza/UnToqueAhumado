...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col relative pb-9">
      <section className="w-full relative rounded-b-[2.5rem] shadow-md z-10 flex flex-col items-center justify-center pt-12 pb-16 bg-cover bg-center md:bg-[center_67%] bg-[url('https://res.cloudinary.com/djhfc1hjo/image/upload/q_auto/f_auto/v1777950960/IMG_0779_sg5a2x.jpg')]">
  ...
  AHUMADO
        ...
        <p className="mt-3 font-bold tracking-[0.2em] uppercase text-xs text-orange-50">Burguers artesanales premium</p>
      </section>
