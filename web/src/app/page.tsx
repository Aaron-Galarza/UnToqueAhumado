...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col relative pb-9">
      <section className="w-full relative rounded-b-[2.5rem] shadow-md z-10 flex flex-col items-center justify-center pt-12 pb-16 bg-cover bg-center bg-[url('https://res.cloudinary.com/djhfc1hjo/image/upload/f_auto,q_auto,w_1200/v1777950957/IMG_0702_twwrp9.jpg')]">
